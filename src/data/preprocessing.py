...
# Ensure all values in the 'income' column are strings
...
# Ensure all values in the 'country_code' column are strings
...
if IMPUTATON_TYPE == "KNN":
    ...
    # Fit the imputer on the training dataset and transform it
